...
public class OrderManagementControllerTests : IDisposable
{
    ...
    public async Task CreateOrder_ValidRequest_ReturnsOrderDto()
    {
        ...
        _mockContext.Setup(x => x.Products.FindAsync(product.Id)).Returns(new ValueTask<Product>(Task.FromResult(product)));
        ...
        _mockEmailService.Verify(e =>
            e.SendOrderConfirmationEmailAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<Order>()),
            Times.Once);
    }
